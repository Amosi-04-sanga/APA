    ...
    <div className='bg-[#161359] mt-20 text-center md:text-left text-white'>
        <div className="flex flex-col">
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-2">
                <Image src='/images/icons/youtube.svg' className='block cursor-pointer' alt='icon' width={36} height={36} />
                <Image src='/images/icons/facebook.svg' className='block cursor-pointer' alt='icon' width={32} height={32} />
                <Image src='/images/icons/instagram.svg' className='block cursor-pointer' alt='icon' width={32} height={32} />
                <Image src='/images/icons/tiktok.svg' className='block cursor-pointer' alt='icon' width={30} height={30} />
                <Image src='/images/icons/whatsaap.svg' className='block cursor-pointer' alt='icon' width={30} height={30} />
            </div>
        </div>
