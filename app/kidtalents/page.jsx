...
const page = () => {
  return (
    <div className='px-8'>
        ...
        <p className="mt-4">Children discover their talents through exploration and practice. By trying different activities such as painting, singing, playing an instrument, or solving puzzles, they can find what they enjoy and what they are naturally good at. Parents and teachers play a key role in helping children identify and develop their talents by providing encouragement and opportunities to learn.</p>


        <h1 className='text-center font-bold text-xl mt-8'>kids talents recent posts</h1>
