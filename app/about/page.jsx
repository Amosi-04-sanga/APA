    ...
    <div className="px-8 md:flex gap-4 justify-around">
      ...
      <p className="mt-4">
        APO was born out of a deep passion for parenting since 2024 by just one person
         who is the founder and the innovator of the name APO. He was not comfortable with
          the way education systems and how parents tend to treat their children while the
           way of parenting is clear and easy yet it is not seen by most parents and
            gurdians. 
        
      </p>
      <p className="mt-4">Neus Njugunya who is the most passionate man of parenting decided
             to create platform for solving all the problems concerning parenting, and from
              him all people with the same passion have gathered to make true solutions
               of parenting problems starting from Africa to the world by the deep desire to
        create a trusted space for parents to connect, learn, and grow.</p>

        <p className="mt-2">Our journey began with sharing personal experiences and research-based
        insights, and today, we have grown into a community of parents
        supporting each other.</p>

        <p className="mt-2">
          We are committed to provide practical parenting
